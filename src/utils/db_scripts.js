...
const db_sql = {
    ...
    "Q17"  : `select id, min_amount, max_amount, percentage, is_max, currency, counter from slabs where company_id ='{var1}' and deleted_at is null ORDER BY counter ASC`,
    "Q18"  : `insert into slabs(id,min_amount, max_amount, percentage, is_max, company_id, currency, counter) values('{var1}','{var2}','{var3}','{var4}','{var5}', '{var6}', '{var7}', '{var8}') returning * `,
