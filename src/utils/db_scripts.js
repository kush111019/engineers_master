...
const db_sql = {
    ...
    "Q144" : `select id, message_id, to_mail, from_mail,from_name, mail_date, subject, mail_html, mail_text, mail_text_as_html, company_id, created_at from emails where company_id = '{var1}' and deleted_at is null order by created_at desc`,
