...
GROUP BY 
  ...
  Q483: `SELECT id , timeline , start_date , end_date , amount FROM marketing_budget WHERE company_id = '{var1}' AND TO_CHAR(start_date::date, 'MM-DD-YYYY') >= '{var2}' AND TO_CHAR(end_date::date, 'MM-DD-YYYY') <= '{var3}' AND deleted_at IS NULL`,
