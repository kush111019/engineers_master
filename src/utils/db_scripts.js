...
const db_sql = {
    ...
    "Q4"   : `select id, full_name,company_id, email_address,encrypted_password,mobile_number,phone_number,role_id from users where email_address = '{var1}' and deleted_at is null` ,
