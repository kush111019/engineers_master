...
const db_sql = {
    ...
    "Q8"   : `SELECT id, full_name,company_id, email_address,mobile_number,phone_number,address,role_id, avatar,expiry_date, is_verified, is_admin, is_locked, created_by FROM users WHERE id = '{var1}' and deleted_at IS NULL` ,
