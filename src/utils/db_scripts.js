...
su.sales_id;
`,
"Q406":`SELECT rr.sales_id, MAX(CAST(rr.recognized_amount AS VARCHAR)) AS recognized_amount, cc.customer_name, s.target_amount
...
AND s.deleted_at IS NULL
AND cc.deleted_at IS NULL
GROUP BY rr.sales_id, cc.customer_name, s.target_amount
