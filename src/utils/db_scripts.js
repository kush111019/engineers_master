...
const db_sql = {
    ...
    "Q147" : `select id, email, app_password, host, company_id from imap_credentials where company_id = '{var1}' and deleted_at is null`,
    ...
    "Q152" : `insert into imap_credentials(id, email, app_password, company_id, host) values('{var1}','{var2}','{var3}','{var4}','{var5}') returning *`                               
