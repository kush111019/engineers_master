module.exports.notifications = function (msg) {
                                ...
                                <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr>
                                        <td style="padding:0 35px;">
                                            ...
                                            This Email is to inform you that <b> ${msg} </b>.</br>
                                            </br>
                                            
                                            If you have any questions. </br>Please email us at <a href=""
                                            style="text-decoration:none !important; font-weight:500; margin-top:5px; color: #1bb2cc; font-size:14px;padding:4px 4px;display:inline-block;"><u>Hirise@contactus.com</u></a><br>
