module.exports.recurringPayment = function(customerName){
    let payment = `
    <!doctype html>
    <html lang="en-US">
                        ...
                        <tr>
                            <td style="text-align:center;">
                              <a href="http://143.198.102.134:8080/" title="logo" target="_blank">
                                <img src="/hiriselogo.png" alt="logo" />
                              </a>
                            </td>
                        </tr>
                        <tr>
                                    ...
                                    <tr>
                                        <td style="padding:0 35px;">
                                            ...
                                            <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                                This email is generated to remind you that the recurring date is crossed for customer ${customerName}.
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
